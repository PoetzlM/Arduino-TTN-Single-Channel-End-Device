...
// 0x70.
static const u1_t PROGMEM APPEUI[8] = { XXXXXX };
void os_getArtEui (u1_t* buf) {
  memcpy_P(buf, APPEUI, 8);
}

// This should also be in little endian format, see above.
static const u1_t PROGMEM DEVEUI[8] = { XXXXXX };
...
void onEvent (ev_t ev) {
  ...
  switch (ev) {
    ...
    case EV_JOINED:
      ...
      //after join is completed, ttn server updates teh frequency table for the end device
...
void setup() {
  ...
  //implicit call of join function
  //join function sets up the frequency and SF table
